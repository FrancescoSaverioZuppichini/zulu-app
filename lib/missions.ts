...
export const missions: Record<string, Mission[]> = {
    ...
    , "fsln": [
...

        {
            mission_id: '3a',
            type: 'primary_mission',
            primary_objective: 'Nel fascicolo del Progetto P e nelle lettere vi sono riportate alcune informazioni fondamentali per capire il mio scopo, Chi sono le fazioni finanziatrici di questo progetto?.',
...

        {
            ...
            required_missions: ['3a', '3b', '3c'] //All specified missions required
        }],
    "test": [
        {
            mission_id: 'debug_1',
