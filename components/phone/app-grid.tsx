...
export function AppGrid() {
  return (
    <div className="flex-1 flex flex-col justify-between h-full bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100">
      {/* Main content area */}
      <div className="flex-1 flex flex-col">
        {/* App Icons Grid */}
        <div className="grid grid-cols-4 gap-4 p-4 w-full max-w-md mx-auto mt-4">
          <Link href="/messages">
      ...
      <div className="w-full px-3 pb-6 pt-1 flex justify-center">
